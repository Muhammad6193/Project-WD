...
TOKEN = os.getenv('MTM2NTY0ODQ4MDU3MTIzMjMyOA.G_M7Tk.Y2hDXopc0azBqYnnhdBwfGPJo3rs0CGcXGPMDQ')
...
async def on_message(message):
    if message.content == '!done':
        ...
        embed = discord.Embed(
            ...
            description="Voici l'état des avis envoyés 📝",
